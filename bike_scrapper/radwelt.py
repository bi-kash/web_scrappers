...
def check_overlay(driver):
    ...
    WebDriverWait(shadow_root, 5).until(
        EC.presence_of_element_located((By.CLASS_NAME, "sc-eDvSVe.kaITzn"))
    )
...
def scrap_list():
    ...
    n_page = int(
        driver.find_element(By.CLASS_NAME, "paging--display")
    ...
    for page in range(1, n_page + 1):
        ...
        for bike in bikes:
            ...
            stock_sizes = [
                ...
                for item in bike.find_element(
                    By.CLASS_NAME, "product-variants"
        ...
        driver.get(
            "https://www.radwelt-shop.de/fahrraeder/mountainbikes/?p={}&o=1&n=100".format(
                page + 1
            )
        )
    return rows
